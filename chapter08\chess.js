...
var Chess = new function() {
  ...
  this.placeBoard = function() {
    ...
    self.topPos = (parseInt((h - self.boardSize + self.panelHeight) / 2));
    if (self.topPos < self.panelHeight) {
      self.topPos = self.panelHeight;
    }
  ...
  this.placePanel = function() {
    ...
    panelDiv.style.width = self.boardSize + 'px';
    panelDiv.style.left = self.leftPos + 'px';
    panelDiv.style.top = (self.topPos - self.panelHeight) + 'px';
  };
